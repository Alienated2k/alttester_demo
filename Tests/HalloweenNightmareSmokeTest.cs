...
public class HalloweenNightmareSmokeTest
{
	...
	[Test, Order(1)]
	public void Test_FindStartButtonAndClickOnThem()
	{
    ...
    public void Test_MoveCameraBackwardAndCheckPosition()
    {
        ...
        driver.PressKey(AltKeyCode.S, power, duration);
        camera.UpdateObject();
    ...
    public void Test_MoveCameraForwardAndCheckPosition()
    {
		...
		driver.PressKey(AltKeyCode.W, power, duration);
        camera.UpdateObject();
    ...
    public void Test_FindCameraBackwardButtonAndClickOnThem()
    {
        ...
        driver.HoldButton(buttonPosition, duration);
        camera.UpdateObject();
    ...
    public void Test_FindJoystickAndRotateCameraLeft()
    {
        ...
        driver.MoveTouch(fingerId, new AltVector2(joystickStartPosition.x + offsetX, joystickStartPosition.y));
	...
	public void Test_FindCandiesAndClickOnThem()
	{
		...
		while (currentScore < maxScore)
		{
			...
			driver.Tap(candyPosition, count);
	...
	[Test, Order(11)]
	public void Test_WaitForSecondaryObjectiveWindowAndCheckText()
	{
	...
	public void Test_FindPlaqueCandlesAndClickOnThem()
	{
		...
		driver.Tap(plaquePosition, count);
	...
	public void Test_FindPauseButtonAndClickOnThem()
	{
		...
		driver.Tap(buttonPosition, count);
    ...
    public void Test_FindBackButtonAndClickOnThem()
    {
        ...
        driver.PressKey(AltKeyCode.Escape, power);
